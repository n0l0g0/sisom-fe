...
export function InvoicePrint({
  ...
  return (
    ...
    >
      ...
      <div className="mt-3">
        <div className="w-full text-center text-[11px] px-3 py-2 bg-[#fff4e6] border border-[#f5a987] rounded break-words">
          ประกาศ: หอพักได้ย้ายระบบมาใช้ LINE ในการบริหารจัดการ และจะยกเลิกแอป Horganice กรุณาแอดไลน์หอพักที่ @sisomoffice เพื่อรับบิล, <span className="whitespace-nowrap">แจ้งซ่อม</span> และติดต่อเจ้าหน้าที่
        </div>
      </div>
    </div>
  );
